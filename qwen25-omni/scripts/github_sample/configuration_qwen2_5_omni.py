...
class Qwen2_5OmniTextConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        image_layer_idx=None,
        audio_layer_idx=None,
        random=False,
        frame=False,
        image_prune_ratio=None,
        audio_prune_ratio=None,
        ...
        **kwargs,
        ...
        self.audio_layer_idx=audio_layer_idx,
        self.random=random,
        self.frame=frame,
        self.image_prune_ratio=image_prune_ratio,
        self.audio_prune_ratio=audio_prune_ratio,
